<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Reg" %>
            ...
            <tr>
                ...
                <td class="auto-style10">
                    <table cellpadding="2" cellspacing="8" class="auto-style11">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Label ID="Label5" runat="server" Font-Size="XX-Small" ForeColor="#EAB0AC" Text="确认密码(RePassWord)"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14" align="right">
                       ...
                       <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Label ID="Label4" runat="server" Font-Size="XX-Small" ForeColor="#EAB0AC" Text="密保问题(SecurityQuestion)"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Label ID="Label6" runat="server" Font-Size="XX-Small" ForeColor="#EAB0AC" Text="说点什么吧(IntroduceYouself)"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14" align="right">
                                <asp:Image ID="Image6" runat="server" ImageUrl="~/images/system/Rekey.png" Width="25px" Height="25px"/>
                            </td>
                            <td class="auto-style12">
                                <asp:TextBox ID="TextBox_Remark" runat="server" Height="26px" Font-Size="X-Small" TextMode="MultiLine" Width="99%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td class="auto-style13" align="right">
                                <asp:ImageButton ID="ImageButton1" runat="server" Height="25px" ImageUrl="~/images/system/login.png" Width="25px" OnClick="ImageButton1_Click" />
                            </td>
                            <td class="auto-style13" align="right">
                                <asp:Button ID="Button_find" runat="server" align="left" BackColor="#D04F44" BorderStyle="None" Font-Bold="True" ForeColor="#66FFFF" Text="忘记密码" Height="16px" Width="65px" />
                                <asp:Button ID="Button_Reg" runat="server" Text="注册" BackColor="#FFE655" BorderStyle="None" Font-Bold="True" Font-Size="X-Large" ForeColor="White" OnClick="Button_Reg_Click" />
                            </td>                         
                        </tr>
                    </table>
                    </td>
